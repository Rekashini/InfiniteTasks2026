...
namespace EmployeeApplication
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n2.Employee DOB after 01/01/1990");
            ...
            Console.WriteLine("\n5. Employees in Chennai: " + empList.Count(e => e.City == "Chennai"));
            ...
            Console.WriteLine("\n7.Employees joined after 01/01/2015: " + empList.Count(e => e.DOJ > new DateTime(2015, 1, 1)));

            // 8.Display total number of employee whose designation is not “Associate”
            Console.WriteLine("\n8. Not Associate: " + empList.Count(e => e.Title != "Associate"));
            ...
            empList.GroupBy(e => new { e.City, e.Title })
                   .ToList()
                   .ForEach(g => Console.WriteLine($"{g.Key.City} - {g.Key.Title} : {g.Count()}"));
