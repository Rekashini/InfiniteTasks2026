...
insert into Emp (empno, ename, job, [mgr-id], hiredate, sal, [comm.], deptno) values(7369, 'Smith',  'Clerk',7902, convert(date,'17-12-1980',105), 800,  null, 20),
...
--after update
update Emp set sal = sal * 1.10where deptno = ( select deptno from Dept where dname = 'Research');
...
select d.deptno,d.dname,sum(e.sal) as Total_Salary from Dept d left join Emp e on d.deptno = e.deptno group by d.deptno, d.dname;
